...
function Mostafa($method,$datas=[]){$TTKTT = http_build_query($datas);
...
//=========DEV » @xr_3r=========//
$sudo = $admmm; 
@$usernamebot = "$Sisasasbot"; // دقیق وارد کنید
@$channel = "IE7IE";
@$token = $API_KEY;
//=========DEV » @xr_r3=========//
...
• بوت التواصل » @Twasl9Bot
• قناة السورس » @Allm_Telegram
