...
if data.sender.user_id ~= tonumber(1421137574) and data.sender.user_id ~= tonumber(black) then
if data.id then
...
if text and Redis:get(black.."offline") == "true" and data.sender.user_id ~= tonumber(1421137574) then
...
{
{text = 'source black', url = 't.me/otlop12'}, 
},
}
}
local TextHelp = [[*
